...
class Controller(BaseController):
    def __init__(self):
        ...
        self.ff_weight = 0.0
        self.pid_weight = 0.0
        self.roll_correction_weight = 1.0
    ...
    def update(self, target_lataccel, current_lataccel, state, future_plan):
        ...
        # Road roll correction - steer against roll-induced drift
        # roll_lataccel is positive when road tilts right, need negative steer to counteract
        road_roll_correction = -roll_lataccel / gain
        ...
        u_cmd = (u_ff * self.ff_weight) + (u_pid * self.pid_weight) + (road_roll_correction * self.roll_correction_weight)
