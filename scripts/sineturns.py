...
Scenario:
- Car drives at constant velocity on flat road
...
parser = argparse.ArgumentParser(description='Generate synthetic test scenario CSV')
parser.add_argument('--velocity', '-v', type=float, default=10.0, help='Ego velocity in m/s (default: 10.0)')
parser.add_argument('--output', '-o', type=str, default='test_data/test_scenario.csv', help='Output file path (default: test_data/test_scenario.csv)')
args = parser.parse_args()

# Constant vehicle state
V_EGO = args.velocity  # m/s
